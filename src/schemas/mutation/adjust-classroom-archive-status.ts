...
export const adjustClassroomArchiveStatus = {
  type: ClassType,
  args: {
    classId: { type: GraphQLString },
    setArchived: { type: GraphQLBoolean },
  },
  resolve: async (
    ...
    try {
      ...
      const { classId, setArchived } = args;
      ...
      // Update classroom archive status
      if (setArchived) {
...
export default adjustClassroomArchiveStatus;
