...
export const blockStudentFromClass = {
  ...
  resolve: async (
    ...
    try {
      ...
      // Set students ClassMembership status to blocked
      classMembership.status = ClassMembershipStatus.BLOCKED;
      await classMembership.save();

      // Remove student from any rooms within the class that the student is a part of
...
export default blockStudentFromClass;
